...
const REQUIRED_INDEXES = [
  ...
  { name: "send_quota_event_global_rule_created_idx", table: "send_quota_event", unique: false, expressions: ["global_rule_id", "created_at"] },
  { name: "send_quota_event_scoped_rule_created_idx", table: "send_quota_event", unique: false, expressions: ["scoped_rule_id", "created_at"] },
  { name: "send_quota_event_scoped_rule_user_created_idx", table: "send_quota_event", unique: false, expressions: ["scoped_rule_id", "user_id", "created_at"] },
